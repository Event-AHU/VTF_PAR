...
expand_attr_words = [
    'female', 'A person age is less than 16','16','A person age ranged from 17 to 30','A person age ranged from 31 to 45',
    'A person body is fat', 'A person body is normal', 'A person body is thin', 'A person is a customer', 'A person is a clerk',
    'A person is bald head', 'A person is long hair', 'A person is black hair', 'A person is hat', 'A person is glasses', 'A person is muffler',
    'A person top is a shirt', 'A person top is a sweater', 'A person top is a vest', 'A person top is a t-shirt', ' A person top is a cotton', 'A person top is a jacket', 'A person top is a suit up',
    'A person top is a tight', 'A person top is a short sleeve',
    'A person wears long trousers underneath ', 'A person wears skirt underneath ', 'A person wears short skirt underneath ', 'A person wears dress underneath ', 'A person wears jeans underneath ',
    'A person wears tight trousers underneath  ',
    'A person shoes is leather', 'A person shoes is sport', 'A person shoes is boots', 'A person shoes is cloth', 'A person shoes is casual',
    'A person carrying a backpack', 'A person carrying a shoulder bag', 'A person carrying a hand bag', 'A person carrying a box', 'A person carrying a plastic bag', 'A person carrying a paper bag',
    'A person carrying hand trunk', 'A person carrying other',
    'A person is calling', 'A person is talking', 'A person is gathering in somewhere', 'A person is holding somethings', 'A person is pushing somethings', 'A person is pulling somethings',
    'A person is raising his arm', 'A person is raising his hand' 
]
short_attr_words = [
    'female', 'age is less than 16', 'age ranged from 17 to 30', 'age ranged from 31 to 45',
    'body is fat', 'body is normal', 'body is thin', 'customer', 'clerk',
    'bald head', 'long hair', 'black hair', 'hat', 'glasses', 'muffler',
    'shirt', 'sweater', 'vest', 't-shirt', 'cotton', 'jacket', 'suit up',
    'tight', 'short sleeve',
    'long trousers', 'skirt', 'short skirt', 'dress', 'jeans', 'tight trousers',
    'leather', 'sport', 'boots', 'cloth', 'casual',
    'carrying a backpack', 'carrying a shoulder bag', 'carrying a hand bag', 'carrying a box', 'carrying a plastic bag', 'carrying a paper bag',
    'carrying a hand trunk', 'carrying other',
    'calling', 'talking', 'gathering', 'holding', 'pushing', 'pulling',
    'raising arm', 'raising hand'
]
